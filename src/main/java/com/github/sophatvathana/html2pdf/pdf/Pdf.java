package com.github.sophatvathana.html2pdf.pdf;

import com.github.sophatvathana.html2pdf.pdf.configurations.WrapperConfig;
import com.github.sophatvathana.html2pdf.pdf.page.Page;
    ...
    private String[] getCommandAsArray() throws IOException {
        ...
        for (Page page : pages) {
            if (page.getType().equals(PageType.htmlAsString)) {
                ...
                File temp = File.createTempFile("pdf" + UUID.randomUUID().toString(), ".html");
